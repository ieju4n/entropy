...
##########################################################################
#Example (multiscale_time_depend_entropy function using SampEn)
##########################################################################
...
method="SampEn" #choose the method SampEn or Cross-SampEn, default SampEn
r=0.2
...
sn<-(series[,3]) #It extracts the time series to compute multiscale time-dependent entropy 
