...
if (Sys.info()[1]=="Windows"){dyn.load("cross-sampen.dll")}
if (Sys.info()[1]=="Linux") {dyn.load("cross-sampen.so")}
...
if (Sys.info()[1]=="Windows"){dyn.unload("cross-sampen.dll")}
if (Sys.info()[1]=="Linux") {dyn.unload("cross-sampen.so")}
A=output$At/((N-m)^2)
